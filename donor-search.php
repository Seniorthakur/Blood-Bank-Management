...
<html>
  ...
  <body>
                <div class="container">
                <h2><strong>Search Donor</strong></h2>
                    <div class="mx-auto" style="width: 400px;">
                    
                        <form method="post" action="" id="searchform" class="form-inline">
                            </div>
                            <div class="form-group mx-sm-2 mb-2 ">
                                <label for="inputPassword2" class="sr-only" name = "search_item" id="search_item" >Search</label>
                                <input type="text" class="form-control" name = "search_item" id="search_item" placeholder="Search...">
            ...
            $sql = "SELECT * FROM donor_reg WHERE fname LIKE '%$hay%' OR age LIKE '%$hay%' OR  branch LIKE '%$hay%' OR  phone LIKE '%$hay%' OR  bloodg LIKE '%$hay%' OR  today LIKE '%$hay%' ";
            // echo $sql;
