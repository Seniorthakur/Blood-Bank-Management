...
<html>
  ...
  <body>
      <div class="center">
        <label for="title" class="title">Donor Login</label>
       <br/>
       </div>
       <div class="space"></div> 
    ...
    <input type="submit" value="Login" name="login" size="25px">
    </form>
    <br/>
    <a href="./donorform.php" style="text-decoration:none"><p><div class="error"><span>Don't Have Account ?</span></p></div></a>
...
if(isset($_POST['login']))
{
   ...
   $q=$db->prepare( "SELECT * FROM donor where user='$user' && pass='$password'");
   $q->execute();
