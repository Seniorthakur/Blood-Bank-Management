...
<html>
  ...
  <body>
   ...
   <label for="terms" class="terms">Yes, i agree all <a href="assets/files/TermandConditions.pdf"  style="text-decoration:none">Terms & Condition.</a></label> <span class="error">* </span>
  ...
  if(isset($_POST['submit']))
  {
    ...
    $addres=$_POST['addres'];
    $gender=$_POST['gender'];
    $q=$db->prepare("INSERT INTO patient_reg (today,branch,fname,age,email,phone,bloodg,addres,gender) VALUES 
  ...
  <br/>
  <a href="./patientlogin.php" style="text-decoration:none"><p><div class="error"><span>Do Have Account ?</span></p></div></a><br/>
  <button type="button" class="button" onclick="window.location.href='./donorForm.php'"><span>Donar Form</span></button>
  <div class="center">
